...
It is not a one-command scaffold. HiggsAgent currently provides reference architecture, contracts, and project patterns rather than a packaged `init` command.
